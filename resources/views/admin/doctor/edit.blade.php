                        ...
                        <div class="row g-0">
                            <div class="col-12 col-xl-12 order-xl-2">
                                <div class="card-body p-4 p-sm-5">
                                    <h5 class="card-title">Editanto doctor</h5>
                                        ...
                                        <div class="row g-3">
                                            ...
                                            <div class="col-12">
                                                ...
                                                <div class="ms-auto position-relative">
                                                    ...
                                                    <select class="form-control radius-30 ps-5" name="typeProfession_id"
                                                        id="">
                                                        <option class="form-control" value="">Seleccionar</option>
                                                        @foreach ($typeProfessions as $typeProfession)
                                                            <option class="form-control"
                                                                {{ $doctor->typeProfession_id == $typeProfession->id ? 'selected' : '' }}
                                                                value="{{ $typeProfession->id }}">
